...
show_help() {
    ...
    echo ""
    echo "  --file <path>         PDF file to translate (for pdf mode)"
    echo ""
    echo "  --arxiv <id>          arXiv ID to download PDF (e.g., 2601.09012v2)"
    echo "                        Automatically downloads from arxiv.org/pdf/"
    echo "                        Mutually exclusive with --file"
    echo ""
    ...
    echo ""
    echo "  # Download and translate from arXiv"
    echo "  ./run-examples.sh translate --mode pdf --arxiv 2601.09012v2"
    echo ""
